...
The row index $i\in\\{1,\ldots,n\\}$ is counting in the $x$-direction and the column index $j \in\\{1,\ldots,m\\}$ is counting in the $y$-direction. The value of $l_{ij}$ determines the amount of walls of a cell using a 4 bit coding, which will be explained below.
