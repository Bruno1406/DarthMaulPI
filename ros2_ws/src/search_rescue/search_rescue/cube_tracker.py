class Cube:
    def __init__(self, tag_id, x_cm, y_cm, color_id):
        self.tag_id = tag_id
    ...
    def add_color_vote(self, color_id):
        ...
        self.color_votes[color_id] = self.color_votes[color_id] + 1
